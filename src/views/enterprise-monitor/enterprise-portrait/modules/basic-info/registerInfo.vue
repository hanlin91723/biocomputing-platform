    ...
    <table class="project-table">
      ...
      <tr class="project-table-tr">
        ...
        <td class="project-value">
          {{ registerInfo?.registeredCapital
          }}{{ registerInfo?.registeredCapitalUnit || "" }}
        </td>
        <td class="project-name">成立日期</td>
        <td class="project-value">
          {{ registerInfo?.incorporationDate?.split("T")[0] }}
        </td>
        <td class="project-name">核准日期</td>
        <td class="project-value">
          {{ registerInfo?.approvalDate?.split("T")[0] }}
        </td>
      </tr>
      <tr class="project-table-tr">
      ...
      <tr class="project-table-tr">
        ...
        <td class="project-value" colspan="5">
          {{ registerInfo?.businessDescription }}
        </td>
      </tr>
    </table>
  </div>
