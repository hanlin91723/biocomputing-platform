<template>
  <div>
    <h3 class="title">严重违法 {{seriousIllegalTotal}}</h3>
      ...
      <el-table-column prop="office" label="作出决定机关(列入)" width="398"></el-table-column>
      <el-table-column prop="inclusionReason" label="列入严重违法失信企业名单原因" width="400"></el-table-column>
    </el-table>
    <!-- 分页器 -->
